...
(add-to-list 'package-archives '("me" . "https://code2080.github.io/packages/"))
...
(defun develop-dot()
  ...
  (let (upstream)
    ...
    (url-copy-file "https://raw.githubusercontent.com/code2080/dots/master/.emacs" upstream t)
